// ===== 1. API KEY (Safe: browser లో మార్చదు) =====
    ...
    for(const m of MODELS){
        try{
            const res=await fetch(
                "https://googleapis.com"+m+":generateContent?key="
                +API_KEY,
...
const rec=new SR(); rec.lang='en-US'; // Telugu కి 'te-IN' గా మార్చండి
